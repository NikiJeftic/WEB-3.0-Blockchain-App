...
const NavbarItem= ({title, classProps}) =>{
    return(
        <li className={`mx-4 curos-pointer ${classProps}`}>
            {title}
        </li>
    )
}
...
const Navbar=()=> {
    ...
    //State varible in functional component
    ...
    return (
        <nav className="w-full flex md:justify-center justify-between items-center p-4">
            ...
            {/* Changing icon for toggle menu and setting true or false */}
            ...
            {/* If toggle is true list the items */}
                {toggleMenu && (
